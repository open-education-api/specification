...
The specification can be downloaded as a whole in [yaml](../oeapi.yaml) and in [json](../oeapi.json)

[![OOAPI information model that feeds OOAPI specification](../source/ooapi_v6.png)](../source/ooapi_v6.png)
*OOAPI information model that feeds OOAPI specification (click to enlarge)*
