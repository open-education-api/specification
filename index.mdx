# OEAPI - V6.0-rc.3 Information Model

OpenAPI (fka Swagger) specification for the Open Education API.

The specification can be downloaded as a whole in <a href="./oeapi.yaml" download>yaml</a>
and in <a href="./oeapi.json" download>json</a>

<figure>
  <a target="_blank" href="../source/ooapi_v6.png">
  <img src="./source/ooapi_v6.png" alt="OEAPI information model that feeds OEAPI specification" width="100%" class="img-responsive" />
  </a>
  <figcaption> OEAPI information model that feeds OEAPI specification (click to enlage)</figcaption>
</figure>

## Model

The model provides an overview of the educational domain that is modelled and
forms the basis of the OEAPI. The overarching educational concept is not exposed
